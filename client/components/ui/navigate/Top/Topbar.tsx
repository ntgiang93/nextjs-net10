...
import { NotificationCenter } from '@/components/ui/drop-down/notification/NotificationCenter';
...
export const Topbar = (props: ITopbarProps) => {
  const { setCompactMode, isCompact, toggleSidebar } = props;
  ...
  return (
    <Navbar classNames={{ wrapper: 'max-w-full' }}>
      <NavbarContent justify={'start'}>
        ...
        <ExtButton className={'lg:hidden'} isIconOnly color={'transparent'} onPress={toggleSidebar}>
          <ArrowRight03Icon />
        </ExtButton>
      </NavbarContent>
      ...
      <NavbarContent justify="center">
        <Button
          ...
          variant="bordered"
          className={
            'justify-between text-default-600 transition-opacity duration-300 w-60 max-md:w-40'
          }
          onPress={onOpen}
          radius={'full'}
        >
      ...
      <FunctionSearchModal isOpen={isOpen} onOpenChange={onOpenChange} />
    </Navbar>
  );
};
