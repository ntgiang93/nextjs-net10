...
export const IconSelect = (props: IconSelectProps) => {
  ...
  const filteredIcons = useMemo(() => {
    ...
    return iconList.filter((name) => name.toLowerCase().includes(searchTerm.toLowerCase()));
  }, [iconList, searchTerm]);
  ...
  return (
    <div className="relative w-full">
      <Input
        ...
        variant={variant}
        value={selectedIcon || ''}
        placeholder={placeholder || `${msg('select')} icon`}
        size={size}
      ...
      >
        <PopoverTrigger>
          <div
            ...
            aria-label="Open Select Popover"
          />
        </PopoverTrigger>
                      ...
                      {Array.from({ length: COLS }).map((_, colIndex) => {
                        ...
                        return (
                          <Button
                            key={colIndex}
                            isIconOnly
                            variant={selectedIcon === iconName ? 'solid' : 'light'}
